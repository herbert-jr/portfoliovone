    ...
    <section className={styles.resume} id="resume">
      ...
      <div className={styles.resume__content}>
        ...
        <p>
          ...
          Desenvolvimento Web. Onde já completei os módulos obrigatórios e estou
          cursando a parte de especialização em <strong>Java</strong>.
        </p>
        <p>
          Atualmente estou cursando a Faculdade de Análise e Desenvolvimento de
          Sistemas na Faculdade Digital Descomplica, afim de me tornar um
          profissional mais completo.
        </p>
        <p>
          Por isso estou em busca de uma oportunidade para colocar em prática
          tudo que aprendi até aqui e mostrar meu potencial. Se você chegou até
          aqui, dá uma olhada no meu{" "}
          <Link
